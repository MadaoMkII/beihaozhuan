module.exports = app => {
    ...
    router.post('/user/updateInfo', app.middleware.authenticatedMiddleware(`客服`), controller[`userAccount`].updateUserInfo);
    ...
    router.post('/user/updateAdmin', app.middleware.authenticatedMiddleware(`客服`), controller[`userAccount`].updateAdmin);
    router.post('/user/disableUserAdminStatus', app.middleware.authenticatedMiddleware(`客服`),
    ...
    router.get('/user/getInviteLink', app.middleware.authenticatedMiddleware(`客服`), controller[`userAccount`].generatorInviteLink);
    ...
    router.get(`/preLogin`, controller[`wechatController`].preLogin);
