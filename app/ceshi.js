...
// //     return decrypted;
// // };
// const x = { bbc: 'plat', xqa: 'cbz', aqa: 'cbz' };
...
//   const publicKey = pubKey; // publicPem.toString();
//   // 加密信息用buf封装
//   const buf = Buffer.from(resultStr, 'utf-8');
//   // buf转byte数组
...
//     const privateKey = privateKey2;// privatePem.toString();
//     // 经过base64编码的密文转成buf
//     const buf = Buffer.from(date, 'base64');
//
//     // buf转byte数组
...
//     resultStr = resultStr + `${key}=${obj[key]}&`;
//   });
//   const src = CryptoJS.enc.Utf8.parse(resultStr);
//   const encrypted = CryptoJS.AES.encrypt(src, key, { iv, mode: CryptoJS.mode.CBC, padding: CryptoJS.pad.Pkcs7 });
//   return encrypted.ciphertext.toString().toUpperCase();
// };
// const aaa = encryptSign({
//   uuid: 'ADVck15314cx0003laa383n2grq6',
//   userUUid: 'ck169fe3b001m4kuf2rq0efv7',
//   timeStamp: '1575344001654' });
// console.log(aaa);
