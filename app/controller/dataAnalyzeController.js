...
class dataAnalyzeController extends Controller {
  ...
  async advDetail(ctx) {
    try {
      ...
      const result = await ctx.service.analyzeService.getAdvDetail(condition, option);
      this.success(result);
    } catch (e) {
  ...
  async countAdv(ctx) {
    try {
      ...
      const result = await ctx.service.analyzeService.countAdv(option, condition.source);
      this.success(result);
    } catch (e) {
      this.app.logger.error(e, ctx);
      this.failure();
  ...
  async countAdvForChart(ctx) {
    try {
      ...
      const result = await ctx.service.analyzeService.countAdvForChart(beginDate);
      this.success(result);
    } catch (e) {
      this.app.logger.error(e, ctx);
      this.failure();
  ...
  async countGoodForChart(ctx) {
    try {
      ...
      const result = await ctx.service.analyzeService.countGoodForChart(beginDate);
      this.success(result);
    } catch (e) {
      this.app.logger.error(e, ctx);
      this.failure();
