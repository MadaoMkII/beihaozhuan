...
class missionController extends Controller {
  async createMission(ctx) {
    try {
      ...
      const mission = await ctx.service.missionService.createMission(missionEntity);
  ...
  async setMissionStatus(ctx) {
    try {
      ...
      const result = await ctx.service.missionService.setMissionStatus(condition);
      this.success(result);
    } catch (e) {
      this.app.logger.error(e, ctx);
      this.failure();
  ...
  async updateMission(ctx) {
    try {
      ...
      if (condition !== false) {
        ...
        const result = await ctx.service.missionService.updateMission(condition);
        this.success(result);
      }
    } catch (e) {
      this.app.logger.error(e, ctx);
  ...
  async getMissions(ctx) {
    try {
      ...
      if (condition !== false) {
        ...
        const result = await ctx.service.missionService.getMission(condition, option);
        this.success(result);
      }
    } catch (e) {
      this.app.logger.error(e, ctx);
  ...
  //   const result = await ctx.service.missionProcessingTrackerService.requireMissionToTrack(ctx.user._id);
  //   this.success(result);
  // }
}
