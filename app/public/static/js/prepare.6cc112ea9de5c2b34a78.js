            ...
            request: function (e) {
                ...
                return new o.a(function (o, a) {
                    ...
                    "get" === n.toLowerCase() ? r.params = t : r.data = t, v(r).then(function (e) {
                        ...
                        e.response ? (console.log("error.response"), 401 === e.response.status && (console.log("当前用户未登录"), s.router.push({name: "Login"}))) : s.$message.error("服务器忙")
                    })
                })
                ...
                return new o.a(function (o, a) {
                    ...
                    "get" === n.toLowerCase() ? r.params = c.a.stringify(t) : r.data = c.a.stringify(t), u(r).then(function (e) {
                        ...
                        e.response ? (console.log("error.response"), 401 === e.response.status ? (console.log("当前用户未登录"), s.router.push({name: "Login"})) : 400 === e.response.status && console.log("当前手机号已注册")) : s.$message.error("服务器忙")
                    })
                })
            }
        };
...
//# sourceMappingURL=prepare.6cc112ea9de5c2b34a78.js.map